...
window.INDUSTRIES = [
  ...
  { key:'fa', en:'FACTORY AUTOMATION', ja:'ファクトリーオートメーション', img:'assets/img/case-machinery.jpg', note:'FA・生産ライン',
  ...
  { key:'plant', en:'PLANT', ja:'プラント', img:'assets/img/case-machinery.jpg', note:'プラント・化学',
