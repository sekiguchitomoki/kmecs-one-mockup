...
window.NEWS = [
  ...
  { id:'n3', date:'2026.06.23', cat:'イベント情報', title:'【7/23 オンライン】造船メーカー向け「IACS UR E26 の主要要素と Moxa ソリューション」',
  ...
  { id:'n4', date:'2026.06.18', cat:'イベント情報', title:'【7/2 オンライン】アプリケーション別に学ぶ ロータリエンコーダの使い分け（POSITAL）',
  ...
  { id:'n5', date:'2026.06.15', cat:'イベント情報', title:'【Moxa 7/9 オンライン】止まりにくく、保守しやすい装置づくりのための通信構成',
  ...
  { id:'n6', date:'2026.06.04', cat:'イベント情報', title:'【Moxa 6/23 オンライン】IACS UR E26 対応におけるネットワーク設計の課題と未来',
  ...
  { id:'n7', date:'2026.05.21', cat:'イベント情報', title:'【6/11 オンライン】基板検査治具の段取り替えをもっと手軽に',
  ...
  { id:'n9', date:'2026.05.12', cat:'イベント情報', title:'【製造業向け】EU サイバーレジリエンス法（CRA）最新動向 解説セミナー',
  ...
  { id:'n10', date:'2026.04.28', cat:'イベント情報', title:'ワイヤレスジャパン ×ワイヤレス・テクノロジー・パーク（WTP）2026 に出展いたします',
